...
public class Homegou {
	...
	private String customerid_tuihuo;// 退货

	public String getCustomerid_tuihuo() {
		return customerid_tuihuo;
	}

	public void setCustomerid_tuihuo(String customerid_tuihuo) {
		this.customerid_tuihuo = customerid_tuihuo;
	}
