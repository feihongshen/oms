 ...
 *
 */
public enum HuitongtxFlowEnum {
	TMS_ACCEPT("TMS_ACCEPT", FlowOrderTypeEnum.RuKu.getValue(), "入库信息反馈"), // 同时推送库房进
																			// TMS_STATION_IN
	TMS_STATION_OUT("TMS_STATION_OUT", FlowOrderTypeEnum.ZhongZhuanChuKuSaoMiao.getValue(), "分站出库"), TMS_STATION_IN("TMS_STATION_IN", FlowOrderTypeEnum.FenZhanDaoHuoSaoMiao.getValue(), "分站进"), TMS_DELIVERING(
	...
	private HuitongtxFlowEnum(String tmall_state, int flowordertype, String text) {
