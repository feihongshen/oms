...
//品骏达外单所需要的字段
public class WeiSuDaWaiDan {
	private String custOrderNo;//cwb
	...
	public void setCalculateWeight(int calculateWeight) {
	...
	public int getAssuranceFee() {
		return assuranceFee;
	}
	public void setAssuranceFee(int assuranceFee) {
