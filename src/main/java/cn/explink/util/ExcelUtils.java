...
public abstract class ExcelUtils {
	...
	public void excel(String[] firstLine, String sheetName, String fileName, String filePath, boolean mapcheck) throws Exception {

		if (!mapcheck) {
			System.out.println("导出终止!");
			File myFilePath = new File(filePath + fileName);
			if (!myFilePath.exists()) {// 判断文件是否已经生成
				return;
			}
			myFilePath.delete(); // 删除空文件
			return;
		}
	...
	public void excelLikeDmp(HttpServletResponse response, String[] firstLine, String sheetName, String fileName) throws Exception {
