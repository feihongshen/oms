...
public class UtilEmail {
	...
	public static void main(String args[]) throws Exception {
		String[] sendTo = { "363268116@qq.com" };
		utilSend(sendTo, "易普联科提示您", "<html><body><a target='_blank' href='http://www.baidu.com'>go 百度</a></body></html>");
	}

	/**
	 * 发送邮件接口 testEmail.utilSend(recipients,subject,message)
	 * （发送对象）recipients：在调用前先定义一个string数组，再把数组名传进方法里.如：String[] recipients = {
	 * "363268116@qq.com" }; （标题）subject："找回密码提示" （内容）message：
	...
	public static void utilSend(String recipients[], String subject, String message) throws MessagingException {
		...
		// System.out.println("Sucessfully Sent mail to "+recipients);
