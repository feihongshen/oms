...
public class FinalVar {
	...
	public static final String SELECT_ERROR = "400";// 数据表没有数据，没做账户配置
	...
	public static final String SMS_MODE = "您好，您在[{c}]的订单已由[{did}][{dphone}]送出，18点前查询及投诉请拨打029-86519750【陕西黄马甲】";// 基于手机号的活动接口
