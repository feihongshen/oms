 ...
 * 正常入库环节
 */
public class IntoWarehousToJson implements OrderFlowInterface {
	...
	public String getBody(OrderFlow orderFlow) {
		...
		if (this.getCustomerid() > 0) {
			body.append("<li><span>").append("供货商：</span><span id='Customerid" + this.getCustomerid() + "'>" + this.getCustomerid()).append("</span></li>");
		}
