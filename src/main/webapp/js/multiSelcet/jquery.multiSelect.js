...
if (jQuery) (function($) {
    ...
    $.extend($.fn, {
        multiSelect: function(o, callback) {
          ...
          //  if (o.selectAllText == undefined) o.selectAllText = "Select All";
            ...
            $(this).each(function() {
                ...
                $(select).next('.multiSelect').children('INPUT.multiSelect_txt').width(iWidth).focus(function() {
                ...
                $(select).next('.multiSelect').next('.multiSelectOptions').find('INPUT:checkbox').click(function() {
                    ...
                    //check the current is select all.
                    var isSelectAll = true;
                    $(this).parent().parent().find('INPUT:checkbox[checked!=true]').each(function() {
                        if ($(this).parent().text() != o.selectAllText) isSelectAll = false;
                    });
                    if (isSelectAll)
                    ...
                    if (callback) callback($(this), display, values);
                });
        ...
        multiSelectOptionsHide: function() {
            $(this).removeClass('active').removeClass('focus').next('.multiSelectOptions').hide();
        },
        ...
        multiSelectOptionsShow: function() {
            ...
            // set width
            $(this).next('.multiSelectOptions').css({ width: $(this).width() + 24 });
        ...
        multiSelectUpdateSelected: function(o) {
            ...
            if (i == 0) {
                $(this).prev('Div.multiSelect').children('INPUT.multiSelect_txt').val(o.noneSelected);
            } else {
                if (o.oneOrMoreSelected == '*') {
                    ...
                    display = display.substr(0, display.length - 2);
                    $(this).prev('Div.multiSelect').children('INPUT.multiSelect_txt').val(display);
                } else {
                    $(this).prev('Div.multiSelect').children('INPUT.multiSelect_txt').val(o.oneOrMoreSelected.replace('%', i));
                }
            }
        },
