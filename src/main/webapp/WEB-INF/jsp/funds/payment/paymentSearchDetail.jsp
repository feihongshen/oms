...
<div style="overflow-x: scroll; " id="scroll2">
	<table width="1500" border="0" cellspacing="1" cellpadding="0" class="table_2" id="gd_table">
	   <tr class="font_1">
				...
				<td align="center" valign="middle" bgcolor="#eef6ff" >收件地址</td>
				<td width="120" align="center" valign="middle" bgcolor="#eef6ff"  >电话 </td>
				<td width="120" align="center" valign="middle" bgcolor="#eef6ff"  >手机</td>
				<td width="100" align="center" valign="middle" bgcolor="#eef6ff"  >邮编</td>
				<td width="100" align="center" valign="middle" bgcolor="#eef6ff" >货物金额</td>
				<td width="100" align="center" valign="middle" bgcolor="#eef6ff">代收金额</td>
				<td width="100" align="center" valign="middle" bgcolor="#eef6ff">应退金额</td>
				<td width="100" align="center" valign="middle" bgcolor="#eef6ff">当前状态</td>
		</tr>
		<% 
		long k=0;
		...
		%>
				<tr bgcolor="#FF3300">
					...
					<td align="right" valign="middle"><%=c.getFlowordertype()==FlowOrderTypeEnum.JuShou.getValue()?c.getReceivablefee():0%></td>
...
function excelExp(){
	window.location.href="<%=request.getContextPath()%>/funds/searchdetail_excel";
	return true;
}
function back(){
	window.location.href="<%=request.getContextPath()%>/funds/payment_return";
	return true;
}
