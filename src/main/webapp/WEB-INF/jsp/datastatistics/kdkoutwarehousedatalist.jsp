...
<div class="right_box">
	...
	<tr>
		<td align="left">
			...
			<select name ="customerid" id ="customerid" multiple="multiple" style="width: 300px;">
		        ...
		        <br/>
			库房名称：<input name="branchname" id="branchname" onkeyup="selectallnexusbranch('<%=request.getContextPath()%>','nextbranchid',$(this).val());"/>
			下一站：
	...
	<form action="<%=request.getContextPath()%>/datastatistics/exportExcle" method="post" id="searchForm2">
		...
		<input type="hidden" name="sign" id="sign" value="<%=ModelEnum.KDKChuKuDingdantongji.getValue() %>"/>
