...
<div class="right_box">
	<div class="right_title">		
		<form action ="<%=request.getContextPath() %>/orderflow/xiufu" method ="post" id ="batchForm">
		<br>订单号：<br>
		&nbsp;&nbsp;&nbsp;<textarea name="cwb" cols="20" rows="10" ></textarea>修复的状态：<input type="text" name="type"/>
		<input type="submit" name="button3" id="btnval2" value="确定" class="button" />
		<br/>结果：<br>&nbsp;&nbsp;&nbsp;<textarea name="cwbss" cols="200" rows="30" ><%=results %></textarea>
		<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=password %><br>
		</form>
	</div>
