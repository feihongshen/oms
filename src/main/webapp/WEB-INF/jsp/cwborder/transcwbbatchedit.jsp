...
$(document).ready(function() {
	$("#btnval").click(function(){
		var ccount = $("#cwbarea").val().split("\n");
		var rcount = $("#cwbremark").val().split("\n");
...
<div class="right_box">
	<div class="right_title">
		<form action ="<%=request.getContextPath() %>/order/transcwbsavebatchedit" method="post" id="batchForm">
		<table width="100%" border="0" cellspacing="1" cellpadding="10" class="table_2" >
			<tr>
				...
				<td align="center" valign="middle" bgcolor="#f8f8f8"><strong>更新运单号[<font color ="red" id ="cwbremarkcount">0</font>]个</strong></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center" valign="middle" ><script><%if(request.getAttribute("SuMessage")!=null){%>resetcwb();resettranscwb();alert('<%=request.getAttribute("SuMessage")%>');<%}%></script></td>
				</tr>
		</table>
		</form>
	</div>
