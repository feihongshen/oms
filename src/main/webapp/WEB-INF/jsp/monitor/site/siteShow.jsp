...
<div class="right_box">
	...
	<tr>
		<td align="left">
		<input type ="button" id="back" value="返回" class="input_button2" onclick="javascript:location.href='<%=request.getContextPath()%>/monitorsite/back'"/>
	...
	<form action="<%=request.getContextPath()%>/monitorsite/dateShowExport" method="post" id="searchForm2">
